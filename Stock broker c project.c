...
void order();
void order_details();
//void ledger_balance_calculator();
//void total_tax_calculator();
//void total_brokerage_calculator();
void contract_note();
void exit_program();
...
{ case 1: system("CLS");
 ...
 // case 6: total_tax_calculator();break;
  case 7: system("CLS");
          order();break;
  case 8: system("CLS");
          order_details();break;
...
{   char clid[20];
	...
	else
	{
	    ...
	    while(fread(&ordet,sizeof(ordet),1,tb)==1 && flag==0)
